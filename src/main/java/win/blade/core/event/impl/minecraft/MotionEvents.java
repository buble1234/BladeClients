...
public abstract class MotionEvents extends Event {
	...
	private MotionEvents(double x, double y, double z, float yaw, float pitch, boolean onGround) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.yaw = yaw;
