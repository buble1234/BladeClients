...
public class FogBlur extends Module {
    ...
    public FogBlur() {
        addSettings(fogStrength, fogDistance, rainbow, rainbowStrength);
    }
    ...
    public void onRenderWorld(RenderEvents.World event) {
        ...
        ShaderHelper.applyFogBlur(fogStrength.getValue(), fogDistance.getValue(), true, rainbow.getValue(), true, rainbowStrength.getValue());
    }
}