...
import win.blade.common.utils.render.msdf.FontData.AtlasData;
import win.blade.common.utils.render.msdf.FontData.GlyphData;
import win.blade.common.utils.render.msdf.FontData.MetricsData;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public MsdfFont.Builder data(String dataFileName) {
			this.dataIdentifer = Identifier.of("blade", "fonts/" + dataFileName + ".json");
			return this;
		}
		
		public MsdfFont.Builder atlas(String atlasFileName) {
			this.atlasIdentifier = Identifier.of("blade", "fonts/" + atlasFileName + ".png");
			return this;
		}
