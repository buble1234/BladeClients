...
public class TestElement extends Module implements MinecraftInstance, NonRegistrable {

    private WatermarkUIElement watermarkUIElement;

    public TestElement() {
        this.watermarkUIElement = new WatermarkUIElement("TEST", 10, 10, 100, 22);
    ...
    private class WatermarkUIElement extends InteractiveUIElement {
        ...
        public void renderContent(DrawContext context) {
            ...
            float calculatedBackgroundWidth = 100;
            float calculatedBackgroundHeight = 100;
